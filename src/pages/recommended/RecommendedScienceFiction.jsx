...
import { actionMovies } from '../../images/recommended/scifi'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';
const RecommendedScienceFiction = () => {
    ...
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        <div className="button-group-2">
          ...
          <Link to="/recommended/action" className='button-icon-9'>
            <div className='icon-9'>
            💥
            </div>
            <div className='cube-9'>
              <span className='side-9 front-9'>Action</span>
              <span className='side-9 top-9'>Good Shit</span>
            </div>
          </Link>
...
export default RecommendedScienceFiction
