...
import { actionMovies } from '../../images/recommended/thriller'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';

const RecommendedThriller = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        A "Thriller" is a type of mystery with a few key differences. 
        As its name suggests, thrillers tend to be action-packed, 
        page-turners with moments full of tension, anxiety, and fear. Without fail, they are plot-driven stories with plenty of plot twists.
        </div>
        ...
        <div className='other-genres'>
         ...
         <div className="button-group">
          <Link to="/recommended/action" className='button-icon-1'>
            <div className='icon-1'>
              💥
            </div>
            <div className='cube-1'>
              <span className='side-1 front-1'>Action</span>
              <span className='side-1 top-1'>good shit</span>
            </div>
          </Link>
        ...
        <div className="button-group-2">
          <Link to="/recommended/romance" className='button-icon-6'>
            <div className='icon-6'>
            😉
            </div>
            <div className='cube-6'>
              <span className='side-6 front-6'>Romance</span>
              <span className='side-6 top-6'>😍😍😍😍😍</span>
            </div>
          </Link>
...
export default RecommendedThriller
