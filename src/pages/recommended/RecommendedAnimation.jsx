...
import { actionMovies } from '../../images/recommended/animation'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';

const RecommendedAnimation = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        Animation is a filmmaking technique by which still 
        images are manipulated to create moving images. In 
        traditional animation, images are drawn or painted 
        by hand on transparent celluloid sheets cels to be 
        ...
        <div className="button-group-2">
          ...
          <Link to="/recommended/action" className='button-icon-7'>
            <div className='icon-7'>
            💥
            </div>
            <div className='cube-7'>
              <span className='side-7 front-7'>Action</span>
              <span className='side-7 top-7'>Good Shit</span>
            </div>
          </Link>
...
export default RecommendedAnimation
