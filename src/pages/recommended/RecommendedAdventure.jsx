...
import { actionMovies } from '../../images/recommended/adventure'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';

const RecommendedAdventure = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        excitement. Some adventure fiction also satisfies 
        the literary definition of romance fiction.
        </div>
        ...
        <div className='other-genres'>
         ...
         <div className="button-group">
          ...
          <Link to="/recommended/action" className='button-icon-2'>
            <div className='icon-2'>
            💥
            </div>
            <div className='cube-2'>
              <span className='side-2 front-2'>Action</span>
              <span className='side-2 top-2'>Good Shit</span>
            </div>
          </Link>
...
export default RecommendedAdventure
