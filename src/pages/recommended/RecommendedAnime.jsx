...
import { actionMovies } from '../../images/recommended/anime'; 
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        The film category of "Anime" isn't a genre in and of 
        itself; rather, it comprises series and films of all 
        kinds with the distinct style of Japanese animation. 
        The top anime genres vary with what shows are popular 
        at the moment, but they typically feature the same 
        elements of comedy, romance, or science fiction.
        </div>
        ...
        <div className="button-group-2">
          ...
          <Link to="/recommended/action" className='button-icon-8'>
            <div className='icon-8'>
            💥
            </div>
            <div className='cube-8'>
              <span className='side-8 front-8'>Action</span>
              <span className='side-8 top-8'>Good Shit</span>
            </div>
          </Link>
