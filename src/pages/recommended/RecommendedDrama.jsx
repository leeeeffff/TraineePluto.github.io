...
import { actionMovies } from '../../images/recommended/drama'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';
const RecommendedDrama = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        "Drama" is a category or genre of narrative fiction 
        ...
        <div className='other-genres'>
         ...
         <div className="button-group">
          ...
          <Link to="/recommended/action" className='button-icon-4'>
            <div className='icon-4'>
            💥
            </div>
            <div className='cube-4'>
              <span className='side-4 front-4'>Action</span>
              <span className='side-4 top-4'>good shit</span>
            </div>
          </Link>
