...
import { actionMovies } from '../../images/recommended/comedy'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';

const RecommendedComedy = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        Comedy is a genre of fiction that consists of discourses
         or works intended to be humorous or amusing by inducing 
        ...
        <div className='other-genres'>
         ...
         <div className="button-group">
          ...
          <Link to="/recommended/action" className='button-icon-3'>
            <div className='icon-3'>
              💥
            </div>
            <div className='cube-3'>
              <span className='side-3 front-3'>Action</span>
              <span className='side-3 top-3'>Good Shit</span>
            </div>
          </Link>
...
export default RecommendedComedy
