...
import { actionMovies } from '../../images/recommended/horror'; 
import { Link } from 'react-router-dom';
import '../../Styles/recommended/Recommended.css';

const RecommendedHorror = () => {
  ...
  return (
    <div className='Recommended-page'>
      ...
      <div className="slider">
        ...
        frighten or scare. Horror is often divided into the 
        sub-genres of psychological horror and supernatural 
        horror, which are in the realm of speculative fiction.
        </div>
        ...
        <div className='other-genres'>
         ...
         <div className="button-group">
          ...
          <Link to="/recommended/action" className='button-icon-5'>
            <div className='icon-5'>
            💥
            </div>
            <div className='cube-5'>
              <span className='side-5 front-5'>Action</span>
              <span className='side-5 top-5'>good shit</span>
            </div>
          </Link>
        </div>
...
export default RecommendedHorror
